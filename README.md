...
Although **REST** **CRUD** servers are very famous types to spin up a new one even with the help of templates
takes more time than we care to admit. That is where this module comes to play. The main purpose of this module
is to aid the developer to spin up a new **REST CRUD** project in less than a minute with all the durgeroies finished.
